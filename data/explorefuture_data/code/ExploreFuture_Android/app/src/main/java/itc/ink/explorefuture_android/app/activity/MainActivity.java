...
public class MainActivity extends FragmentActivity {
    ...
    public final int UPDATE_DATA_START_MSG=0x01;
    public final int UPDATE_DATA_FINISH_MSG=0x02;
    ...
    public Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == UPDATE_DATA_START_MSG) {
                Log.d(LOG_TAG,"UPDATE_DATA_START_MSG");
            }else if(msg.what == UPDATE_DATA_FINISH_MSG){
