...
public class DataUpdateMode {
    ...
    public static final String SORT_DATA_NEWEST_UPDATE_DATE_TIME_KEY="sort_data_newest_update_date_time";
    ...
    public static final String SORT_DATA_FILE_URL = "http://www.itc.ink/data/explorefuture_data/app/sort/data.json";
    ...
    public static String SORT_JSON_DATA_STR="";
