package itc.ink.explorefuture_android.common_unit.content_list.adapter;
...
public class ContentListDataAdapter extends RecyclerView.Adapter<ContentListDataAdapter.VH> {
    private final static String LOG_TAG = "ContentListDataAdapter";
    private WeakReference<Context> mWeakContextReference;
    private List<ContentListDataMode> mData;

    private ItemClickListener itemClickListener=new ItemClickListener();

    public ContentListDataAdapter(Context mContext, List<ContentListDataMode> mData) {
