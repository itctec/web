...
public class UserDetailsWrapAdapter extends RecyclerView.Adapter<UserDetailsWrapAdapter.WrapperVH> {
    ...
    public UserDetailsWrapAdapter(Context mContext, String id) {
    ...
    public WrapperVH onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE.HEADER_ITEM.ordinal()) {
            View rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.common_unit_user_details_header_item, parent, false);
        ...
        if (position == 0) {
            ...
            SimpleTarget<Drawable> simpleTarget = new SimpleTarget<Drawable>() {
                ...
                public void onResourceReady(Drawable resource, Transition<? super Drawable> transition) {
                    holder.userInfoLayout.setBackground(resource);
                }
            };
    ...
    public class WrapperVH extends RecyclerView.ViewHolder {
        ...
        public WrapperVH(View view, ITEM_TYPE item_type) {
            ...
            if (item_type == ITEM_TYPE.HEADER_ITEM) {
                userInfoLayout = view.findViewById(R.id.user_Details_Person_Info_Layout);
                headPortraitImage = view.findViewById(R.id.user_Details_HeadPortrait_Image);
                nicknameText = view.findViewById(R.id.user_Details_Nickname_Text);
                personalizedSignatureText = view.findViewById(R.id.user_Details_Personalized_Signature_Text);
                fansCountText = view.findViewById(R.id.user_Details_Fans_Count_Text);
                attentionCountText = view.findViewById(R.id.user_Details_Attention_Count_Text);
            } else {
